...
/**
 * Delivers the resource bundle properties for the current user's language in
 * JSON format.
 * 
 * @author fho
 */
public class ResourceBundleHandler extends UserRequestHandler {
    ...
    public ResourceBundleHandler(HttpServletRequest req, HttpServletResponse resp, HttpSession session, PrintWriter output, String uid) {
