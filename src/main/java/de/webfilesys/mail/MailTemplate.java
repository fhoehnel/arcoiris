...
public class MailTemplate {
    ...
    public MailTemplate(String templateFileName) throws IllegalArgumentException {
    ...
    public MailTemplate(File templateFile) throws IllegalArgumentException {
        init(templateFile);
    }
     ...
     * @param varValue
     *            the replacement text for the variable
     */
    ...
    /**
     * Read the template file, replace any variables for wich a replacement text
     * has been defined and return the changed text.
     */
     ...
     * 
     * @param line
     *            the line of text from the source template file
     * @param varName
     *            name of the variable to be replaced
     * @param replaceText
     *            text to be inserted in place of the variable
