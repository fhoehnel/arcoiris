...
public class DiskQuotaInspector extends Thread {
    ...
    public synchronized void run() {
        ...
        while (!shutdownFlag) {
            ...
            if (hour == ArcoirisBlog.getInstance().getDiskQuotaCheckHour()) {
                inspectDiskQuotas();
            }
    ...
    protected void inspectDiskQuotas() {
                    ...
                    if (diskQuota > 0) {
                        ...
                        if (fileSysStat.getTotalSizeSum() > diskQuota) {
                            ...
                            if (ArcoirisBlog.getInstance().getMailHost() != null) {
                                ...
                                if (ArcoirisBlog.getInstance().isMailNotifyQuotaUser()) {
                                    ...
                                    if ((email != null) && (email.trim().length() > 0)) {
                                        ...
                                        try {
                                            String templateFilePath = ArcoirisBlog.getInstance().getConfigBaseDir() + "/languages/diskquota_" + userLanguage + ".template";
        ...
        if ((ArcoirisBlog.getInstance().getMailHost() != null) && ArcoirisBlog.getInstance().isMailNotifyQuotaAdmin()) {
