...
public class FileLinkSelector {
     ...
     * @param afterName
     * @param beforeName
     * @return a FileSelectionStatus object containing selected FileContainer
     *         objects
     */
    public FileSelectionStatus selectFiles(String searchMask[], int pageSize, String afterName, String beforeName) {
        ...
        for (int i = 0; i < filesAndLinks.size(); i++) {
            ...
            if ((!hideMetaInf) || (fileName.charAt(0) != '_') || (!fileName.equals(MetaInfManager.METAINF_FILE))) {
        ...
        // String lastFileOfAll=(String)
        // selectedFiles.elementAt(selectedFiles.size()-1);
