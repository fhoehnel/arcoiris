...
public class UserComparator implements Comparator {
    ...
    public static final int SORT_BY_ACTIVATED = 6;
    public static final int SORT_BY_LAYOUT = 7;
    public static final int SORT_BY_EMAIL = 8;
    ...
    public int compare(Object o1, Object o2) {
        ...
        if (sortBy == SORT_BY_LAYOUT) {
            if (user1.getCss() == null) {
                if (user2.getCss() == null) {
                    return (0);
                } else {
                    return (-1);
                }
            ...
            return (user1.getCss().toUpperCase().compareTo(user2.getCss().toUpperCase()));
        }

        if (sortBy == SORT_BY_ACTIVATED) {
