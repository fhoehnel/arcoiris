...
public class XslLogonHandler extends XslRequestHandlerBase {
    ...
    public XslLogonHandler(HttpServletRequest req, HttpServletResponse resp, HttpSession session, PrintWriter output, boolean authFailed) {
    ...
    protected void process() {
        ...
        XmlUtil.setChildText(loginElement, "language", ArcoirisBlog.getInstance().getPrimaryLanguage(), false);
