...
public class SessionListHandler extends AdminRequestHandler {
    public SessionListHandler(HttpServletRequest req, HttpServletResponse resp, HttpSession session, PrintWriter output, String uid) {
    ...
    protected void process() {
        ...
        String title = "arcoiris Blog Administration: Active Sessions";
        ...
        while (sessionList.hasMoreElements()) {
            ...
            try {
                ...
                output.print("<td class=\"data\" align=\"left\" valign=\"top\">");
                output.print(ArcoirisBlog.getInstance().getLogDateFormat().format(new Date(session.getCreationTime())));
                output.println("</td>");

                output.print("<td class=\"data\" align=\"left\" valign=\"top\">");
                output.print(ArcoirisBlog.getInstance().getLogDateFormat().format(new Date(session.getLastAccessedTime())));
                output.println("</td>");
