...
public class BroadcastRequestHandler extends AdminRequestHandler {
    ...
    public BroadcastRequestHandler(HttpServletRequest req, HttpServletResponse resp, HttpSession session, PrintWriter output, String uid, String alert) {
    ...
    protected void process() {
        ...
        String title = "arcoiris Blog Administration: broadcast e-mail";
        ...
        output.println("<input type=\"button\" value=\"&nbsp;Cancel&nbsp;\" onclick=\"javascript:window.location.href='" + req.getContextPath()
                        + "/servlet?command=admin&cmd=menu'\">");
        output.println("</td>");
        output.println("</tr>");
