...
public class XmlUtil {
    ...
    /**
     * For compatibility reasons the following is required: If the value of a
     * text node is to be changed, but a CDATA section with this name already
     * exists, the CDATA section is removed an a text node is created or
     * changed.
     * 
     * If the value of a CDATA section is to be changed, but a text node with
     * this name already exists, the text node is removed an a CDATA section is
     * created or changed.
     * 
     */
