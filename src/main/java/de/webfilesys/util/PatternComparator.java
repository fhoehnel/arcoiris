...
public class PatternComparator {
    /**
     * Checks if a string matches a search pattern. The pattern can use the
     * asterisk (*) as wildcard character.<br>
     * The search is not case-sensitive.
     * 
     * @param elementName
     *            the String to be checked against the search pattern
     * @param pattern
     *            the search pattern containing wildcards
     */
