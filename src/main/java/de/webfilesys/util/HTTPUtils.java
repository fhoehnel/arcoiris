...
public class HTTPUtils {
    ...
    private static final int responseCodes[] = { 200, // OK_CODE
            202, // OK_INCOMPLETE
            304, // NOT_MODIFIED
            400, // BAD_REQUEST
            404, // NOT_FOUND
    ...
    static final private String responseMessages[] = { "Document follows", // OK_CODE
    ...
    public static String createHTTPHeader(int responseIdx, String mime_type, int length, boolean closeConnection) {
