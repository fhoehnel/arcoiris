            ...
            while (!documentEnd) {
                try {
                    ...
                    case XMLStreamConstants.START_ELEMENT:
                        ...
                        if ((!tagName.equals("gpx")) && (!tagName.equals("trk")) && (!tagName.equals("trkseg")) && (!tagName.equals("trkpt")) && (!tagName.equals("wpt"))
                                        && (!tagName.equals("ele")) && (!tagName.equals("time")) && (!tagName.equals("metadata")) && (!tagName.equals("name"))
                                        && (!tagName.equals("desc"))) {
                        ...
                        if (tagName.equals("gpx")) {
                            ...
                            xmlOut.println(STYLESHEET_REF.replace("{contextpath}", req.getContextPath()));
                        }
                    ...
                    case XMLStreamConstants.END_ELEMENT:
                        ...
                        if (tagName.equals("time")) {
                            ...
                            /*
                             * if (speed != Double.MIN_VALUE) { double
                             * correctedSpeed = speed;
                             * 
                             * if (prevSpeed != Double.MIN_VALUE) {
                             * correctedSpeed = (prevSpeed * 4 + speed) / 5; }
                             * 
                             * if (correctedSpeed < 0.001f) { // prevent
                             * exponential format correctedSpeed = 0.0f; }
                             * 
