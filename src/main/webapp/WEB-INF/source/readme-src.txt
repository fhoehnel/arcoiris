arcoiris source files for customized user manager implementation
==================================================================

The arcoiris distribution contains 3 source files,
...
To run arcoiris with your own user manager, place the classes
in the WEB-INF/classes directory or your JAR archive in the
WEB-INF/lib directory.

Set the config parameter
  UserManagerClass
in blog.conf to the name of your user manager class.

At startup arcoiris prints the name of the active user manager
