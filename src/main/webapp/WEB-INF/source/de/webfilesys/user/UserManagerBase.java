...
/**
 * Extend this class to implement your own user manager (for example to access
 * an existing user database).
 * 
 * For a description of the methods that must be implemented see the UserManager
 * interface.
 * 
 * The implementing class derived from this base class must call this.start() in
 * the constructor !!!
 */
public abstract class UserManagerBase extends Thread implements UserManager {
    ...
    /**
     * Overwrite this method if your UserManager has to do some actions
     * periodically and/or before server shutdown. Otherwise leave the default
     * implementation of this method untouched.
     */
