...
public interface UserManager {
    ...
    /**
     * Get the disk quota (bytes) of the user. If no disk quota is defined for
     * the user, this method returns -1.
     * 
     * @param userId
     *            the userid of the user
    ...
    /**
     * Get the number of pictures displayed per page. If not defined the method
     * should return fmweb.thumbnailsPerPage .
     * 
     * @param userId
     *            the userid of the user
    ...
    /**
     * Get the document root for the user. If the document root is not defined,
     * this method must return a platform-dependend default value. For Windows
     * this should be "c:\temp" and for UNIX "/tmp".
     * 
     * @param userId
     *            the userid of the user
    ...
    /**
     * Creates a normalized form of the document root. Implemented in abstract
     * base class UserManagerBase. Do not overwrite it!
     * 
     * @param documentRoot
    ...
    /**
     * The user manager thread is being notified before fmweb shutdown. If the
     * user manager is ready for shutdown, it must return true here.
     * 
