...
<html>
  <head>
    ...
    <script type="text/javascript">
      <xsl:attribute name="src"><xsl:value-of select="//contextRoot" />/javascript/gpxOSM.js</xsl:attribute>
    </script>
    <script type="text/javascript">
  ...
  <body>
    <xsl:attribute name="onload">showMultipleOSMTracks()</xsl:attribute>
